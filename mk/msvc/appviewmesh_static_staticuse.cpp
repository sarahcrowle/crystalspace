...
SCF_USE_STATIC_PLUGIN(bodymesh)
SCF_USE_STATIC_PLUGIN(an_debug)
SCF_USE_STATIC_PLUGIN(an_lookat)
SCF_USE_STATIC_PLUGIN(an_noise)
SCF_USE_STATIC_PLUGIN(an_ragdoll)
SCF_USE_STATIC_PLUGIN(an_ragdoll2)
SCF_USE_STATIC_PLUGIN(an_retarget)
SCF_USE_STATIC_PLUGIN(an_speed)
SCF_USE_STATIC_PLUGIN(bodymeshldr)
SCF_USE_STATIC_PLUGIN(splitmorph)
...
SCF_USE_STATIC_PLUGIN(visualdebug)
