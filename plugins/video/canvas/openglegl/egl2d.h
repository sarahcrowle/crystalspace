...
#ifndef __CS_EGL2D_H__
#define __CS_EGL2D_H__

#define EGL_EGLEXT_PROTOTYPES
#include <EGL/egl.h>
#define CS_GLEXTMANAGER_USE_EGL
...
/// XLIB version.
class csGraphics2DEGL : public scfImplementationExt1<csGraphics2DEGL , 
  csGraphics2DGLCommon, iOpenGLInterface>
{
  ...
  int screen_num;
  Window window;
  XVisualInfo *xvis, visual_template;
  Colormap cmap;
  EGLContext active_GLContext;
  EGLConfig egl_config;
  EGLSurface egl_surface;
  EGLint num_configs, num_visuals;
...
public:
  csGraphics2DEGL (iBase *iParent);
  virtual ~csGraphics2DEGL ();
