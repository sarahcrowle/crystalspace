...
/*
 * CrystalSpace:
 * This file is a copy of the one from the Bullet library, with some minor modifications
 * in order to improve the faulty ghost collision management and the falling behavior.
 *
 * The modifications are documented at:
 * - http://bulletphysics.org/Bullet/phpBB3/viewtopic.php?f=9&t=5684
 * - http://bulletphysics.org/mediawiki-1.5.8/index.php/Collision_Callbacks_and_Triggers#Triggers_and_the_btKinematicCharacterController
 *
 * This file has been copied from the 'trunk' branch of the Bullet library, on revision 2643.
 */
...
public:
	...
	{
	        // This is for trigger filtering. See http://bulletphysics.org/Bullet/phpBB3/viewtopic.php?f=9&t=5684
...
void csbtKinematicCharacterController::stepDown ( btCollisionWorld* collisionWorld, btScalar dt)
{
	...
	// Improvement of the falling behavior. See http://bulletphysics.org/Bullet/phpBB3/viewtopic.php?f=9&t=5684
