...
#include "cssysdef.h"
  ...
  #define BIND_EXPORT
#endif
struct BIND_EXPORT _Bind_basemapgen_static_plugins
{
  _Bind_basemapgen_static_plugins ();
};
struct _basemapgen_static_static_use { _basemapgen_static_static_use (); };
_Bind_basemapgen_static_plugins::_Bind_basemapgen_static_plugins () {}
/ Needed to pull in _cs_static_use object file
namespace { _basemapgen_static_static_use _basemapgen_static_static_use_bind; }
