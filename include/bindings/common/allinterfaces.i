...
%define IMESH_APPLY_FOR_EACH_INTERFACE
  ...
  INTERFACE_APPLY(iAnimatedMeshSubMeshFactory)
  INTERFACE_APPLY(iAnimatedMesh)
  INTERFACE_APPLY(iAnimatedMeshSubMesh)
  INTERFACE_APPLY(iAnimatedMeshMorphTarget)
  INTERFACE_APPLY(iAnimatedMeshSocket)
  INTERFACE_APPLY(iAnimatedMeshSocketFactory)
...
%define ANIMATION_APPLY_FOR_EACH_INTERFACE
namespace CS
{
namespace Animation
{
  INTERFACE_APPLY(iBodyBone)
  INTERFACE_APPLY(iBodyBoneCollider)
  INTERFACE_APPLY(iBodyBoneJoint)
  INTERFACE_APPLY(iBodyBoneProperties)
  INTERFACE_APPLY(iBodyChain)
  INTERFACE_APPLY(iBodyChainNode)
  INTERFACE_APPLY(iBodyManager)
  INTERFACE_APPLY(iBodySkeleton)
  INTERFACE_APPLY(iSkeleton)
  INTERFACE_APPLY(iSkeletonAnimation)
  INTERFACE_APPLY(iSkeletonAnimationNode)
  INTERFACE_APPLY(iSkeletonAnimationNodeFactory)
  INTERFACE_APPLY(iSkeletonAnimNode)
  INTERFACE_APPLY(iSkeletonAnimNodeFactory)
  INTERFACE_APPLY(iSkeletonAnimPacket)
  INTERFACE_APPLY(iSkeletonAnimPacketFactory)
  INTERFACE_APPLY(iSkeletonBlendNode)
  INTERFACE_APPLY(iSkeletonBlendNodeFactory)
  INTERFACE_APPLY(iSkeletonDebugNode)
  INTERFACE_APPLY(iSkeletonDebugNodeFactory)
  INTERFACE_APPLY(iSkeletonDebugNodeManager)
  INTERFACE_APPLY(iSkeletonFactory)
  INTERFACE_APPLY(iSkeletonFSMNode)
  INTERFACE_APPLY(iSkeletonFSMNodeFactory)
  INTERFACE_APPLY(iSkeletonIKCCDNode)
  INTERFACE_APPLY(iSkeletonIKCCDNodeFactory)
  INTERFACE_APPLY(iSkeletonIKNode)
  INTERFACE_APPLY(iSkeletonIKNodeFactory)
  INTERFACE_APPLY(iSkeletonIKNodeManager)
  INTERFACE_APPLY(iSkeletonIKPhysicalNode)
  INTERFACE_APPLY(iSkeletonIKPhysicalNodeFactory)
  INTERFACE_APPLY(iSkeletonLookAtListener)
  INTERFACE_APPLY(iSkeletonLookAtNode)
  INTERFACE_APPLY(iSkeletonLookAtNodeFactory)
  INTERFACE_APPLY(iSkeletonLookAtNodeManager)
  INTERFACE_APPLY(iSkeletonManager)
  INTERFACE_APPLY(iSkeletonPriorityNode)
  INTERFACE_APPLY(iSkeletonPriorityNodeFactory)
  INTERFACE_APPLY(iSkeletonRagdollNode)
  INTERFACE_APPLY(iSkeletonRagdollNodeFactory)
  INTERFACE_APPLY(iSkeletonRagdollNodeManager)
  INTERFACE_APPLY(iSkeletonRandomNode)
  INTERFACE_APPLY(iSkeletonRandomNodeFactory)
  INTERFACE_APPLY(iSkeletonRetargetNode)
  INTERFACE_APPLY(iSkeletonRetargetNodeFactory)
  INTERFACE_APPLY(iSkeletonRetargetNodeManager)
  INTERFACE_APPLY(iSkeletonSpeedNode)
  INTERFACE_APPLY(iSkeletonSpeedNodeFactory)
  INTERFACE_APPLY(iSkeletonSpeedNodeManager)
}
}
%enddef
