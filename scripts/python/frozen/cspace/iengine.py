...
class iRenderManagerPostEffects(core.iBase):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    def CreatePostEffect(*args): return _iengine.iRenderManagerPostEffects_CreatePostEffect(*args)
    def AddPostEffect(*args): return _iengine.iRenderManagerPostEffects_AddPostEffect(*args)
    def InsertPostEffect(*args): return _iengine.iRenderManagerPostEffects_InsertPostEffect(*args)
    def RemovePostEffect(*args): return _iengine.iRenderManagerPostEffects_RemovePostEffect(*args)
    def FindPostEffect(*args): return _iengine.iRenderManagerPostEffects_FindPostEffect(*args)
    def GetPostEffectCount(*args): return _iengine.iRenderManagerPostEffects_GetPostEffectCount(*args)
    def GetPostEffect(*args): return _iengine.iRenderManagerPostEffects_GetPostEffect(*args)
    def GetScreenTarget(*args): return _iengine.iRenderManagerPostEffects_GetScreenTarget(*args)
    def GetDepthTarget(*args): return _iengine.iRenderManagerPostEffects_GetDepthTarget(*args)
    def DrawPostEffects(*args): return _iengine.iRenderManagerPostEffects_DrawPostEffects(*args)
    def SetEffectsOutputTarget(*args): return _iengine.iRenderManagerPostEffects_SetEffectsOutputTarget(*args)
    def GetEffectsOutputTarget(*args): return _iengine.iRenderManagerPostEffects_GetEffectsOutputTarget(*args)
    def SetupView(*args): return _iengine.iRenderManagerPostEffects_SetupView(*args)
    def ScreenSpaceYFlipped(*args): return _iengine.iRenderManagerPostEffects_ScreenSpaceYFlipped(*args)
    def SetPostEffectsEnabled(*args): return _iengine.iRenderManagerPostEffects_SetPostEffectsEnabled(*args)
    def SetDepthBuffer(*args): return _iengine.iRenderManagerPostEffects_SetDepthBuffer(*args)
